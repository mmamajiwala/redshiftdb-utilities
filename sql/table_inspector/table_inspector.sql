...
-- Following script provides a SQL script that you can run to help you identify tables where sort keys, distribution keys and column encoding options are missing
-- Execute the script in your SQL client application as superuser
